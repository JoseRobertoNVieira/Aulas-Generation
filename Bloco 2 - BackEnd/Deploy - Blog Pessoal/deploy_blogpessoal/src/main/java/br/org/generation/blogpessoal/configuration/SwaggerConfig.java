...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto do Blog Pessoal").version("1.0.0")
				.license("Apache License Version 2.0").licenseUrl("https://github.com/JoseRobertoNVieira/").contact(contact())
				.build();
	}

	private static Contact contact() {

		return new Contact("José Roberto Nóbrega Vieira", "https://github.com/JoseRobertoNVieira/", "joserobertonobregavieira@hotmail.com");
